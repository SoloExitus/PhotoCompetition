    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', imagekit.models.fields.ProcessedImageField(default='placeholders/avatar_placeholder.jpg', upload_to='user_thumbnail/', verbose_name='Миниатура пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', django_fsm.FSMField(choices=[('new', 'new'), ('approved', 'approved'), ('rejected', 'rejected'), ('removed', 'removed')], default='new', max_length=50, verbose_name='Состояние поста')),
                ...
                ('previous_image', models.ImageField(default='placeholders/photo_placeholder.png', upload_to='photo/', verbose_name='Предыдущее используемое изображение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='competition.photopost', verbose_name='Пост')),
